        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="mt-5 text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight font-pj">
              Quality resources shared by students
            </h1>
            <p className="max-w-lg mx-auto mt-6 text-base leading-7 text-gray-600 font-inter">
              Thousands of practice questions, mock exams, and revision notes
              curated by students who've aced their tests. Simulate real exam
